...
SOSE_CH1_Rubric = `Purpose: Get started on your blog post and complete the first two sections.
...
SOSE_CH2_Rubric = `Purpose: Continue building your blog post
...
SOSE_CH3_Rubric = `Purpose: Continue building your blog post
...
In the solution(s) portion of the blog, the students should reference atleast 1 technology/framework from their tech stack summary and reference 1 component. Example: On Oppias live server, their sound file in MidiJS had a different file name than on their test server. This was caused by our Angular Services component, which was likely causing the file to be renamed during production. 
Rubric:
Technology/Framework: Does the student include atleast one technology or one framework used?
Component: Does the student mention atleast one component from their project?
...
The student should provide atleast one form of proof that their solution works. Example: In my teams github solution, we provided videos of our solution working on various devices and a slow/throttled network connection.
Rubric:
Proof: Does the student provide atleast one form of proof that their solution works. (e.g., screenshot, gifs, videos, quotes from PR maintainer)
...
SOSE_CH4_Rubric = `Purpose: Continue building your blog post
